...
def report_problem(request):
    """View for users to report bike problems"""
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Set default phone number from user profile if not provided
...
def my_problems(request):
    """View for users to see their reported problems"""
...
def problem_detail(request, problem_id):
    """View to show detailed information about a specific problem"""
...
def all_problems(request):
    """View for agents and admins to see all problem reports"""
...
def add_response(request, problem_id):
    """View for agents to add responses to problem reports"""
    problem = get_object_or_404(ProblemReport, id=problem_id)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Update problem status if this is marked as a solution
...
def update_problem_status(request, problem_id):
    """View for agents to update problem status and assignment"""
    problem = get_object_or_404(ProblemReport, id=problem_id)
...
def problem_stats(request):
    """View to show statistics about problem reports"""
